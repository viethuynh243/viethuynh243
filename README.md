...
I authored **1,582** commits across the repositories below, last refreshed 2026-08-19. Where a repository has several contributors, the count is mine alone. 🔒 marks a private repository.
...
| **slay-hub** 🔒 | Check-in, CMS and admin console for a community org, on Supabase edge functions. | TypeScript · Supabase | **170** of 213 |
...
| Project | What it does | Stack | My commits |
|---|---|---|:--:|
| **tieu-mich** 🔒 | Discord butler on a Claude tool-calling loop over a RAG knowledge base, with minigames, voice tracking and a ticket queue. My largest codebase. | Python · Claude API | **688** |
