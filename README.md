...
I authored **1,485** commits across the repositories below, last refreshed 2026-08-10. Where a repository has several contributors, the count is mine alone. 🔒 marks a private repository.
...
| Project | What it does | Stack | My commits |
|---|---|---|:--:|
| **tieu-mich** 🔒 | Discord butler on a Claude tool-calling loop over a RAG knowledge base, with minigames, voice tracking and a ticket queue. My largest codebase. | Python · Claude API | **654** |
