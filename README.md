...
I authored **2,197** commits across the repositories below, last refreshed 2026-08-29. Where a repository has several contributors, the count is mine alone. 🔒 marks a private repository.
...
| **TEDI-BRAIN** 🔒 | Flags expired standards cited in bridge and road design dossiers, resolving every TCVN and QCVN reference against its current legal status. | Python | **612** |
...
| **slay-hub** 🔒 | Check-in, CMS and admin console for a community org, on Supabase edge functions. | TypeScript · Supabase | **300** of 395 |
...
| Project | What it does | Stack | My commits |
|---|---|---|:--:|
| **tieu-mich** 🔒 | Discord butler on a Claude tool-calling loop over a RAG knowledge base, with minigames, voice tracking and a ticket queue. My largest codebase. | Python · Claude API | **719** |
